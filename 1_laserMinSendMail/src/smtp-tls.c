...
#define CC      "<and_mastro95@hotmail.it>"

static const char *payload_text[] = {
  "Date: Mon, 23 Apr 2017 09:54:29 +1100\r\n",
  "To: " TO "\r\n",
  "From: " FROM "(Home-Intrusion Detection Robot)\r\n",
  "Cc: " CC "(Another example User)\r\n",
  //"Message-ID: <dcd7cb36-11db-487a-9f3a-e652a9458efd@"
  //"rfcpedant.example.org>\r\n",
  //"Content-Disposition: attachment; filename=\"myfile.txt\"\n",
  "Subject: POSSIBLE INTRUSION DETECTED\r\n",
  "\r\n", /* empty line to divide headers from body, see RFC5322 */
  "We detected a possible intrusion.\r\n",
  "\r\n",
  "Snapshots of the area are attached.\r\n",
  "Content-Type: application/FILETYPE; name=\"myfile.txt\" \r\n",
  //"Check RFC5322.\r\n",
  NULL
};
